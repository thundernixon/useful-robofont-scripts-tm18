...
# glyphsToNotMove = typicallyNarrowGlyphs + somewhatNarrowGlyphs + somewhatWideGlyphs + typicallyWideGlyphs
...
#markColor = (0, 1*random.random(), 1*random.random(), 0.5)
...
def glyphIsNormalWidth(glyphName):
    ...
    # if glyphName not in typicallyNarrowGlyphs and glyphName not in typicallyWideGlyphs and glyphName not in somewhatNarrowGlyphs and glyphName not in somewhatWideGlyphs and glyphName not in narrowPunctuation:
